...
// Allocates a VkDescriptorSet that you can pass as ImTextureId to render images
IMGUI_API void*       ImGui_ImplGlfwVulkan_AddTexture(VkSampler sampler, VkImageView image_view);
