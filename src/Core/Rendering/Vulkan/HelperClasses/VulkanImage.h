		...
		namespace Rendering
		{
			namespace Vulkan
			{
				...
				public:
					 ...
					 */
					static void transitionImageLayout(vk::Image, vk::Format, vk::ImageLayout oldLayout, vk::ImageLayout newLayout, vk::ImageSubresourceRange subresource_range = vk::ImageSubresourceRange({}, 0, 1, 0, 1));
					/**
