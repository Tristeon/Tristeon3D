...
namespace ImGui
{
	...
	IMGUI_API bool			TSelectable(const char * label, bool selected, ImGuiSelectableFlags flags, const ImVec2 & size_arg, ImTextureID user_texture_id = nullptr); //Tristeon version of ImGui's selectable
